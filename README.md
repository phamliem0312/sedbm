# SEDBM 2025 — Static Website Deployment Guide (Windows)
...
```
127.0.0.1   sedbm2025.local
```

Rồi truy cập `http://sedbm2025.local`
...
2. Tạo repository mới: **New repository**
   - Repository name: `sedbm2025` (hoặc `<username>.github.io` để dùng domain gốc)
   - Chọn **Public**
...
git init
git add .
git commit -m "Initial commit - SEDBM2025 website"
git branch -M main
git remote add origin https://github.com/<username>/sedbm2025.git
...
4. Sau 1-2 phút, website sẽ live tại:
   `https://<username>.github.io/sedbm2025/`
...
2. Chọn **GitHub** → chọn repository `sedbm2025`
3. Cấu hình:
   - **Branch**: `main`
...
| `partner1.png` ~ `partner8.png` | Logo đối tác | 200 × 100px (PNG nền trong) |
